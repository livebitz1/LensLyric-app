  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.scrollViewContent}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>Nearby Photographers</Text>
            <TouchableOpacity>
              <Text style={styles.seeAllText}>See all</Text>
            </TouchableOpacity>
          </View>
        ...
        <View style={styles.section}>
          <View style={styles.premiumCard}>
            <Text style={styles.premiumTitle}>Boost Your Visibility with Premium Plans</Text>
            <Text style={styles.premiumSubtitle}>Showcase your portfolio and reach more clients.</Text>
...
const styles = StyleSheet.create({
  ...
  favoriteButton: {
    ...
    top: 10,
    right: 10,
    backgroundColor: Colors.light.cardBackground, // Changed from rgba(255,255,255,0.7) to cardBackground
    borderRadius: 20,
    width: 36,
    height: 36,
    justifyContent: "center",
